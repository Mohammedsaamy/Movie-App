        ...
        <div className="col-lg-8 text-start px-lg-5 px-0">
          <div className='d-flex justify-content-between'>
            <div>
              ...
              <p className="text-dark mb-3 d-flex">
                {/* <StarRating rating={moviesDetails.vote_average / 2}/>  */}
                {/* <span className='ms-4'>{moviesDetails.vote_count}</span> */}
              </p>
            ...
            <div>
              ...
              isMovieInWatchlist
              ? 
              <span className="text-end px-3" style={{color: 'green'}} onClick={removeFromWatchlist}>
                <FontAwesomeIcon icon={Like} className='fs-5' />
              </span>
              :
              <span className="text-end px-3" style={{color: 'black'}} onClick={addToWatchlist}>
          ...
          <div className="d-flex flex-wrap my-3">
            {movieGenres.map((genre) => {
              return(
                <p className='rounded-5 text-light px-3 py-1 me-3' style={{backgroundColor: 'black'}}>{genre.name}</p>
              )
            })}
          </div>
