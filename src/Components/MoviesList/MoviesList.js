...
export default function MovieList() {
  ...
  return (
    <>
      <div className='search-part bg-body-secondary my-2 p-2 rounded rounded-1 ' >
        ...
        <form className='input-group' onSubmit={(event) => handelSubmit(event)}>
          ...
          <button type="submit" class="btn text-light" style={{backgroundColor: 'black'}}>search</button>
        </form>
      </div>
