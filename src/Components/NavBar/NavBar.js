...
export default function NavBar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg px-5 text-light" style={{backgroundColor: 'black'}}>
      <div className="container-fluid">
        <NavLink className='navigations navbar-brand text-light ' style={({isActive}) => {return {fontWeight: isActive ? "bold" : ""};}} to='/'>Home</NavLink>
        <NavLink className='navigations navbar-brand text-light ' style={({isActive}) => {return {fontWeight: isActive ? "bold" : ""};}} to='about-us'>About Us</NavLink>
        ...
        <div className="ms-auto px-5 d-flex align-items-center ">
          <div className="dropdown text-light">
            ...
            <ul className="dropdown-menu">
              <li><a className="dropdown-item" style={{color: 'black'}} onClick={() => setContextLanguage("ar")}>AR</a></li>
              <li><a className="dropdown-item" style={{color: 'black'}} onClick={() => setContextLanguage("en")}>EN</a></li>
